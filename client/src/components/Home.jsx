...
const Home = () => {
  ...
  return (
    <>
      <section
        className={`${bg[activeCup]} pt-[9vh] min-h-screen flex flex-col md:flex-row overflow-hidden bg-gradient-to-b  text-gray-300`}
      >
        {/* left section */}
        <div className="min-h-1/2 p-3 pt-0 md:p-0 md:min-h-full min-w-full md:min-w-3/7 flex justify-center">
          <img src="/images/left.png" className="hidden md:block opacity-60" />
          <div className="flex flex-col items-center md:items-start md:px-0 gap-5 ml-5">
            ...
            <Link
              to="regular-menu"
              className={`${buttonStyles[activeCup]} my-2 py-1 px-10 rounded hover:scale-95 transition-transform cursor-pointer`}
            >
              Check out menu
            </Link>
          </div>
